  ...
  const handlemailStepper = () => {
    return (
      <React.Fragment>
        ...
        <p className={classes.center}>Continue to Gmail</p>
        <br />
  ...
  const handlePasswordStepper = () => {
    return (
      <React.Fragment>
        ...
        <FormControlLabel
          label="Show password"
          control={<Checkbox color="primary" id="show-password" value="" />}
        />
        <br />
        <div className="action">
          <div className={classes.flex}>
            <Typography variant="button" className={classes.link2}>
              Forgot password
            </Typography>
            <Button
              className={classes.btn}
